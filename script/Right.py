...
class UR5Control(RobotControl):
    ...
    def __init__(self):
        ...
        while not rospy.is_shutdown():
            ...
            if V_Right_RG2_front1 > 0.01 and V_Right_RG2_front2 > 0.01 and V_Right_RG2_touch > 0 and Movement < 4 :
                ...
                M1 = sim.simxGetJointPosition(clientID,jointhandles[1],sim.simx_opmode_streaming)[1]  # Left arm joint 2
                #print("the joint2 value is")
                #print(M1)
                #print("the joint3 value is")               
                M2 = sim.simxGetJointPosition(clientID,jointhandles[2],sim.simx_opmode_streaming)[1]  # Left arm joint 2
                #print(M2)
    ...
    def plan(self, p):
        ...
        for j in range(0,100):
            ...
            A5 = plan.joint_trajectory.points[i].positions[4]
